...
//		put.add(Bytes.toBytes(family), Bytes.toBytes(qualifier), Bytes.toBytes(value));
	...
	public static void add(String tableName, String rowKey, String family, String qualifier,int value) throws IOException {
		//杩炴帴鍒皌able
//		HTable table = new HTable(TableName.valueOf(tableName), connection);
		Table table = getConn().getTable(TableName.valueOf(tableName));
		Put put = new Put(Bytes.toBytes(rowKey));
//		put.add(Bytes.toBytes(family), Bytes.toBytes(qualifier), Bytes.toBytes(value));
	...
	public static void add(String tableName, String rowKey, String family, String qualifier,Double value) throws IOException {
		//杩炴帴鍒皌able
//		HTable table = new HTable(TableName.valueOf(tableName), connection);
		Table table = getConn().getTable(TableName.valueOf(tableName));
		Put put = new Put(Bytes.toBytes(rowKey));
...
//			put.add(Bytes.toBytes(family), null, Bytes.toBytes(value));
	...
	public static void add(String tableName, int rowKey, String family, String qualifier, String value) throws IOException {
		//杩炴帴鍒皌able
//		HTable table = new HTable(TableName.valueOf(tableName), connection);
		Table table = getConn().getTable(TableName.valueOf(tableName));
		Put put = new Put(Bytes.toBytes(rowKey));
